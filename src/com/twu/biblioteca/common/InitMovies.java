    ...
    static {
        try {
            movies = new ArrayList<Movie>(Arrays.asList(
                    new Movie(001, "红海行动", InitMovies.dateformat.parse("016-02-2018 11:35:42"), "王兵", 9.5),
                    new Movie(002, "战狼之一", InitMovies.dateformat.parse("02-04-2017 11:35:42"), "吴京", 9.4),
                    new Movie(003, "神秘巨星", InitMovies.dateformat.parse("02-010-2016 11:35:42"), "张浩", 8.5)));
